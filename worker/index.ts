...
const ROUTES: Route[] = [
  ...
  { method: 'POST', pattern: /^\/api\/ws\/tasks$/, handler: R.wsCreate, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/bulk$/, handler: R.wsBulk, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/labels$/, handler: R.wsLabelCreate, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/labels\/([\w-]+)$/, handler: R.wsLabelDelete, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/sprints$/, handler: R.wsSprintCreate, auth: true, rl: 'write' },
  { method: 'PATCH', pattern: /^\/api\/ws\/sprints\/([\w-]+)$/, handler: R.wsSprintPatch, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/sprints\/([\w-]+)$/, handler: R.wsSprintDelete, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/views$/, handler: R.wsViewSave, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/views\/([\w-]+)$/, handler: R.wsViewDelete, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/automations$/, handler: R.wsAutomationCreate, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/automations\/([\w-]+)$/, handler: R.wsAutomationDelete, auth: true, rl: 'write' },
  { method: 'GET', pattern: /^\/api\/ws\/tasks\/([\w-]+)$/, handler: R.wsDetail, auth: true, rl: 'read' },
  { method: 'PATCH', pattern: /^\/api\/ws\/tasks\/([\w-]+)$/, handler: R.wsUpdate, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/move$/, handler: R.wsMove, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/watch$/, handler: R.wsWatch, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/labels$/, handler: R.wsLabelToggle, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/checklist$/, handler: R.wsCheckAdd, auth: true, rl: 'write' },
  { method: 'PATCH', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/checklist\/([\w-]+)$/, handler: R.wsCheckPatch, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/checklist\/([\w-]+)$/, handler: R.wsCheckDelete, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/comments$/, handler: R.wsCommentAdd, auth: true, rl: 'write' },
  { method: 'PATCH', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/comments\/([\w-]+)$/, handler: R.wsCommentPatch, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/comments\/([\w-]+)$/, handler: R.wsCommentDelete, auth: true, rl: 'write' },
  { method: 'POST', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/deps$/, handler: R.wsDepAdd, auth: true, rl: 'write' },
  { method: 'DELETE', pattern: /^\/api\/ws\/tasks\/([\w-]+)\/deps\/([\w-]+)$/, handler: R.wsDepDelete, auth: true, rl: 'write' },
