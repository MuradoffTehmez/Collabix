/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4fb0ed0ea8f2d5c4b3f27de45953313)
...
interface __BaseEnv_Env {
	...
	SITE_ORIGIN: "https://collabix-staging.muradofftehmez01.workers.dev" | "https://collabix.muradofftehmez01.workers.dev";
	APP_URL: "https://collabix-staging.muradofftehmez01.workers.dev" | "https://collabix.muradofftehmez01.workers.dev";
	ARCHIVE_HOT_DAYS: "90";
	JWT_SECRET: string;
	TURNSTILE_SITE_KEY: string;
	ROOM_DO: DurableObjectNamespace<import("./worker/index").RoomDO>;
	PRESENCE_DO: DurableObjectNamespace<import("./worker/index").PresenceDO>;
	RATE_LIMIT_DO: DurableObjectNamespace<import("./worker/index").RateLimitDO>;
	...
	APP_NAME?: "Collabix";
	WORKFLOW?: Workflow<Parameters<import("./worker/index").CollabixWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "RoomDO" | "PresenceDO" | "RateLimitDO";
	}
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "staging";
		SITE_ORIGIN: "https://collabix-staging.muradofftehmez01.workers.dev";
		APP_URL: "https://collabix-staging.muradofftehmez01.workers.dev";
		ARCHIVE_HOT_DAYS: "90";
		JWT_SECRET: string;
		TURNSTILE_SITE_KEY: string;
		ROOM_DO: DurableObjectNamespace<import("./worker/index").RoomDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SITE_ORIGIN" | "APP_URL" | "ARCHIVE_HOT_DAYS" | "JWT_SECRET" | "TURNSTILE_SITE_KEY" | "EMAIL_FROM" | "APP_NAME">> {}
}
